...
GLWidget::GLWidget (QWidget *parent , const QGLWidget *shareWidget, Qt::WindowFlags f) : QGLWidget(parent, shareWidget, f)
{
...
void GLWidget::initializeGL()
{
	...
	Phi = 45*PI/180.0; Tet = 12*PI/180.0; R = 5;
	leftPress = false;
	...
	vB[0].x = 1; vB[0].y = 1; vB[0].z = 0;
	vB[1].x = 2; vB[1].y = 1; vB[1].z = 0;
	vB[2].x = 2; vB[2].y = 2; vB[2].z = 0;
	vB[3].x = 1; vB[3].y = 2; vB[3].z = 0;
	glBindBufferARB(GL_ARRAY_BUFFER_ARB, BufferName[VertexBuffer]);
	glBufferDataARB(GL_ARRAY_BUFFER_ARB, vertexCount * sizeof(vertex), vB, GL_STATIC_DRAW);
	delete [] vB;

	GLushort *iB = new GLushort[vertexCount];
	iB[0] = 0;	iB[1] = 1;	iB[2] = 3;	iB[3] = 2;
	glBindBufferARB(GL_ELEMENT_ARRAY_BUFFER_ARB, BufferName[IndexBuffer]);
	glBufferDataARB(GL_ELEMENT_ARRAY_BUFFER_ARB, vertexCount * sizeof(GLushort), iB, GL_STATIC_DRAW);
	delete [] iB;

	color* cB = new color[vertexCount];
	cB[0].r = 255;	cB[0].g = 0;	cB[0].b = 0;	cB[0].a = 0;
	cB[1].r = 0;	cB[1].g = 255;	cB[1].b = 0;	cB[1].a = 0;
	cB[2].r = 0;	cB[2].g = 0;	cB[2].b = 255;	cB[2].a = 0;
	cB[3].r = 0;	cB[3].g = 0;	cB[3].b = 0;	cB[3].a = 0;

	glBindBufferARB(GL_ARRAY_BUFFER_ARB, BufferName[ColorBuffer]);
	glBufferDataARB(GL_ARRAY_BUFFER_ARB, vertexCount * sizeof(textureCoord), cB, GL_STATIC_DRAW);
	delete [] cB;
}
